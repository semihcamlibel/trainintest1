...
$(document).ready(function () {
	...
	// Generating slides
	var arrCities = ['Amsterdam', 'Rome', 'New—York', 'Singapore', 'Prague','DFsfdgsd']; // Change number of slides in CSS also
	var numOfCities = arrCities.length;
	var arrCitiesDivided = ["A","C","L","A","S","S"];
	...
	var generateSlide = function generateSlide(city) {
		...
		if (arrCities[city].length <= 4) {
			$('.slide--' + numSlide).find('.slide__text').css("font-size", "0vw");
		}
	};
